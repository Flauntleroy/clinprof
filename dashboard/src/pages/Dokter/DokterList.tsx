                                    ...
                                    <tr key={doctor.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-full bg-brand-100 dark:bg-gray-800 flex items-center justify-center text-brand-600 font-semibold overflow-hidden">
                                                    {doctor.foto ? (
                                                        <img src={getMediaUrl(doctor.foto)} alt={doctor.nama} className="w-full h-full object-cover" />
                                                    ) : (
