...
// Menu untuk Makula Bahalap Dashboard
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <ListIcon />,
    subItems: [
      { name: "Daftar Layanan", path: "/layanan", pro: false },
      { name: "Tambah Layanan", path: "/layanan/tambah", pro: false },
    ],
  },
  {
    name: "Fasilitas",
    icon: <TableIcon />,
    subItems: [
      { name: "Daftar Fasilitas", path: "/fasilitas", pro: false },
      { name: "Tambah Fasilitas", path: "/fasilitas/tambah", pro: false },
    ],
  },
  {
    name: "Berita",
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Pengaturan",
    subItems: [
      { name: "Pengaturan Umum", path: "/pengaturan", pro: false },
      { name: "WhatsApp", path: "/pengaturan/whatsapp", pro: false },
    ],
  },
];
