            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><span className="text-[var(--color-gray-300)]">Pemeriksaan Mata</span></li>
                            <li><span className="text-[var(--color-gray-300)]">Operasi Katarak</span></li>
                            <li><span className="text-[var(--color-gray-300)]">Terapi Mata Malas</span></li>
                            <li><span className="text-[var(--color-gray-300)]">Laser Mata</span></li>
                            <li><span className="text-[var(--color-gray-300)]">Kacamata & Lensa</span></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex gap-3">
                                ...
                                <span className="text-[var(--color-gray-300)]">Jl. Contoh No. 123, Kota, Indonesia</span>
                            </li>
                            <li className="flex gap-3">
                                ...
                                <span className="text-[var(--color-gray-300)]">0812-3456-7890</span>
                            </li>
                            <li className="flex gap-3">
                                <svg className="w-5 h-5 text-[var(--color-accent)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span className="text-[var(--color-gray-300)]">info@makulabahalap.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="border-t border-white/10">
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-[var(--color-gray-400)] text-sm">
                        © {currentYear} Klinik Spesialis Mata Makula Bahalap. All rights reserved.
                    </p>
